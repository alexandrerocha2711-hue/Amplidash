...
export const FALLBACK_PARTICIPANTS_DATA = [
  ...
  { id: 'leonardo', name: 'Leonardo', handle: '@leonardo', categories: { exercicio: 0, familia: 2, alimentacao: 3, hobbies: 2, conhecimentos: 1, bestWeek: 1 }, objectives: { exercicio: '3 exercícios na semana', familia: 'Visitar ou falar com meu irmão 1x por semana', alimentacao: 'Apenas 1 iFood/lanche fora na semana', hobbies: 'Basquete 1x por semana (30 min)', conhecimentos: 'Leitura 3x por semana' }, scoreBreakdown: { melhorFato: 1, piorFato: 0 } },
  ...
  { id: 'alexandre-costa', name: 'Alexandre Costa', handle: '@alexcsta', categories: { exercicio: 2, familia: 0, alimentacao: 2, hobbies: 2, conhecimentos: 2, bestWeek: 0 }, objectives: { exercicio: '1 check-in todo dia', familia: '1 encontro em família por semana', alimentacao: '200g carbo + 300g proteína por refeição', hobbies: 'Jogar videogame 1x por semana', conhecimentos: '50 páginas de leitura + 2 podcasts/aulas por semana' }, scoreBreakdown: { melhorFato: 0, piorFato: 0 } },
  { id: 'andrei', name: 'Andrei', handle: '@andrei', categories: { exercicio: 0, familia: 3, alimentacao: 3, hobbies: 3, conhecimentos: 1, bestWeek: 0 }, objectives: { exercicio: 'Academia 3 vezes na semana', familia: '1 jantar por semana com Bettina', alimentacao: 'Manter suplementação 5 dias por semana', hobbies: '1 hora por semana em paz', conhecimentos: 'Rever notas 2h por semana' }, scoreBreakdown: { melhorFato: 0, piorFato: 0 } },
  { id: 'emily', name: 'Emily', handle: '@emily', categories: { exercicio: 2, familia: 4, alimentacao: 1, hobbies: 0, conhecimentos: 0, bestWeek: 0 }, objectives: { exercicio: 'Academia 5x na semana', familia: 'Ligar para mãe e irmã 4x na semana', alimentacao: 'Seguir dieta 5x na semana', hobbies: 'Pintar ou desenhar 1x por semana', conhecimentos: 'Ler todos os dias' }, scoreBreakdown: { melhorFato: 0, piorFato: 0 } },
  ...
  { id: 'mavi', name: 'Mavi', handle: '@mavi', categories: { exercicio: 2, familia: 3, alimentacao: 1, hobbies: 0, conhecimentos: 1, bestWeek: 0 }, objectives: { exercicio: 'Exercício 4x na semana', familia: 'Ver meus pais 1x por semana', alimentacao: '1 refeição livre por semana', hobbies: 'Desenhar 3 peças de roupa por semana', conhecimentos: '1h de leitura por dia' }, scoreBreakdown: { melhorFato: 0, piorFato: 0 } },
  ...
  { id: 'luan', name: 'Luan', handle: '@luan', categories: { exercicio: 0, familia: 3, alimentacao: 0, hobbies: 0, conhecimentos: 3, bestWeek: 0 }, objectives: { exercicio: 'Musculação 3x na semana', familia: 'Ligar para mãe, Karol e avós 1x por semana', alimentacao: '11 refeições saudáveis na semana', hobbies: 'Jogar padel ou futebol 1x por semana', conhecimentos: '3h leitura + Duolingo diário' }, scoreBreakdown: { melhorFato: 1, piorFato: -1 } },
  { id: 'vitor', name: 'Vitor', handle: '@vitor', categories: { exercicio: 0, familia: 4, alimentacao: 1, hobbies: 0, conhecimentos: 0, bestWeek: 0 }, objectives: { exercicio: 'Academia mínimo 2x por semana + esporte (padel)', familia: '1 jantar especial por semana + 1 almoço', alimentacao: 'Zerar refrigerante e reduzir besteiras', hobbies: 'Costurar 1x por semana', conhecimentos: 'Ler 10 páginas de livro de fantasia' }, scoreBreakdown: { melhorFato: 0, piorFato: 0 } },
  { id: 'nicole', name: 'Nicole', handle: '@nicole', categories: { exercicio: 0, familia: 3, alimentacao: 1, hobbies: -1, conhecimentos: 3, bestWeek: -1 }, objectives: { exercicio: 'Exercício físico todos os dias (corrida ou academia)', familia: 'Ligar para minhas irmãs 1x por semana', alimentacao: 'Seguir dieta com apenas 1 refeição livre', hobbies: null, conhecimentos: 'Ler 105 páginas de livro de autoconhecimento' }, scoreBreakdown: { melhorFato: 0, piorFato: -1 } },
  { id: 'bruno', name: 'Bruno', handle: '@bruno', categories: { exercicio: -2, familia: -1, alimentacao: -2, hobbies: -1, conhecimentos: -2, bestWeek: 0 }, objectives: { exercicio: null, familia: null, alimentacao: null, hobbies: null, conhecimentos: null }, scoreBreakdown: { melhorFato: 0, piorFato: 0 } },
