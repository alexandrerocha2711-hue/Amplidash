...
export const PARTICIPANT_PHOTOS_BY_ID = {
  ...
  jf: 'https://drive.google.com/thumbnail?id=1_GdGr_a3k2iQiW8uI6WX7tYKobd64Mad&sz=w1000',
  leonardo: 'https://drive.google.com/thumbnail?id=1HcrWob47DGPscgtWLNns3DHE0qFPlGyF&sz=w1000',
  luan: 'https://drive.google.com/thumbnail?id=1rBhO82CXKjuZvZog93ZK_Extj1yCsgFa&sz=w1000',
...
export const INITIAL_PARTICIPANTS_DATA = [
  ...
  { id: 'jf', name: 'JF', handle: '@jf', categories: { exercicio: 1, familia: 4, alimentacao: 0, hobbies: 4, conhecimentos: 3, bestWeek: 0 }, objectives: { exercicio: '3 exercícios por semana (corrida, academia ou futebol)', familia: 'Almoçar com a família 1x por semana', alimentacao: 'Não beber café após 12h', hobbies: 'Jogar futebol 1x por semana', conhecimentos: '3h de estudo por semana' }, scoreBreakdown: { melhorFato: 0, piorFato: 0 } },
  { id: 'gean', name: 'Gean', handle: '@gean', categories: { exercicio: 0, familia: 2, alimentacao: 0, hobbies: 2, conhecimentos: 4, bestWeek: 1 }, objectives: { exercicio: 'Exercício 3x por semana', familia: 'Ligar para meu irmão 1x por semana', alimentacao: 'Beber 2L de água por dia', hobbies: 'Jogar videogame 1x por semana', conhecimentos: 'Duolingo todos os dias' }, scoreBreakdown: { melhorFato: 1, piorFato: 0 } },
  { id: 'leonardo', name: 'Leonardo', handle: '@leonardo', categories: { exercicio: 0, familia: 3, alimentacao: 4, hobbies: 3, conhecimentos: 2, bestWeek: 1 }, objectives: { exercicio: '3 exercícios na semana', familia: 'Visitar ou falar com meu irmão 1x por semana', alimentacao: 'Apenas 1 iFood/lanche fora na semana', hobbies: 'Basquete 1x por semana (30 min)', conhecimentos: 'Leitura 3x por semana' }, scoreBreakdown: { melhorFato: 1, piorFato: 0 } },
  { id: 'mayra', name: 'Mayra', handle: '@mayra', categories: { exercicio: 0, familia: 3, alimentacao: 1, hobbies: 0, conhecimentos: 3, bestWeek: 2 }, objectives: { exercicio: 'Praticar atividade 3x na semana', familia: '1 aoço ou jantar com meus pais', alimentacao: 'Não comer hambúrguer de segunda a sexta', hobbies: 'Praticar ou conhecer algo novo', conhecimentos: 'Reassistir 2 aulas da pós' }, scoreBreakdown: { melhorFato: 2, piorFato: 0 } },
  { id: 'alexandre-costa', name: 'Alexandre Costa', handle: '@alexcsta', categories: { exercicio: 2, familia: 0, alimentacao: 2, hobbies: 3, conhecimentos: 2, bestWeek: 0 }, objectives: { exercicio: '1 check-in todo dia', familia: '1 encontro em família por semana', alimentacao: '200g carbo + 300g proteína por refeição', hobbies: 'Jogar videogame 1x por semana', conhecimentos: '50 páginas de leitura + 2 podcasts/aulas por semana' }, scoreBreakdown: { melhorFato: 0, piorFato: 0 } },
  { id: 'andrei', name: 'Andrei', handle: '@andrei', categories: { exercicio: 0, familia: 4, alimentacao: 4, hobbies: 3, conhecimentos: 1, bestWeek: 0 }, objectives: { exercicio: 'Academia 3 vezes na semana', familia: '1 jantar por semana com Bettina', alimentacao: 'Manter suplementação 5 dias por semana', hobbies: '1 hora por semana em paz', conhecimentos: 'Rever notas 2h por semana' }, scoreBreakdown: { melhorFato: 0, piorFato: 0 } },
  { id: 'emily', name: 'Emily', handle: '@emily', categories: { exercicio: 2, familia: 5, alimentacao: 1, hobbies: 0, conhecimentos: 0, bestWeek: 0 }, objectives: { exercicio: 'Academia 5x na semana', familia: 'Ligar para mãe e irmã 4x na semana', alimentacao: 'Seguir dieta 5x na semana', hobbies: 'Pintar ou desenhar 1x por semana', conhecimentos: 'Ler todos os dias' }, scoreBreakdown: { melhorFato: 0, piorFato: 0 } },
  ...
  { id: 'mavi', name: 'Mavi', handle: '@mavi', categories: { exercicio: 3, familia: 4, alimentacao: 2, hobbies: 0, conhecimentos: 1, bestWeek: 0 }, objectives: { exercicio: 'Exercício 4x na semana', familia: 'Ver meus pais 1x por semana', alimentacao: '1 refeição livre por semana', hobbies: 'Desenhar 3 peças de roupa por semana', conhecimentos: '1h de leitura por dia' }, scoreBreakdown: { melhorFato: 0, piorFato: 0 } },
  { id: 'camila', name: 'Camila', handle: '@camila', categories: { exercicio: 1, familia: 3, alimentacao: 1, hobbies: 2, conhecimentos: 2, bestWeek: -1 }, objectives: { exercicio: 'Ir de segunda à sábado para academia 6x', familia: 'Entrar em contato com a família 1x por semana', alimentacao: 'Fazer todas refeições do dia', hobbies: '1h por dia para ler livro', conhecimentos: 'Cursos online 1h30 por semana' }, scoreBreakdown: { melhorFato: 0, piorFato: -1 } },
  { id: 'alexandre-neto', name: 'Xandão (Alexandre Neto)', handle: '@xandaoneto', categories: { exercicio: 0, familia: 1, alimentacao: 1, hobbies: 2, conhecimentos: 2, bestWeek: -1 }, objectives: { exercicio: 'Academia 3x por semana', familia: 'Almoçar com minha mãe 3x por semana', alimentacao: 'Sem besteira durante a semana (5 dias)', hobbies: 'Praticar colorir 1x por semana', conhecimentos: 'Duolingo todos os dias' }, scoreBreakdown: { melhorFato: 0, piorFato: -1 } },
  { id: 'luan', name: 'Luan', handle: '@luan', categories: { exercicio: 0, familia: 4, alimentacao: 0, hobbies: 0, conhecimentos: 4, bestWeek: 0 }, objectives: { exercicio: 'Musculação 3x na semana', familia: 'Ligar para mãe, Karol e avós 1x por semana', alimentacao: '11 refeições saudáveis na semana', hobbies: 'Jogar padel ou futebol 1x por semana', conhecimentos: '3h leitura + Duolingo diário' }, scoreBreakdown: { melhorFato: 1, piorFato: -1 } },
  ...
  { id: 'bruno', name: 'Bruno', handle: '@bruno', categories: { exercicio: -1, familia: 0, alimentacao: -1, hobbies: -1, conhecimentos: -1, bestWeek: 0 }, objectives: { exercicio: 'Academia 5x na semana', familia: 'Ligar para algum familiar 1x na semana', alimentacao: 'Manter dieta 80/20', hobbies: 'Assistir pelo menos 1 ep. por semana', conhecimentos: 'Duolingo todos os dias' }, scoreBreakdown: { melhorFato: 0, piorFato: 0 } },
  { id: 'gabriel', name: 'Gabriel', handle: '@gabriel', categories: { exercicio: -4, familia: -4, alimentacao: -4, hobbies: -4, conhecimentos: -4, bestWeek: -1 }, objectives: { exercicio: 'Gabriel Cocozinho não colocou nenhuma meta 💩', familia: 'Gabriel Cocozinho não colocou nenhuma meta 💩', alimentacao: 'Gabriel Cocozinho não colocou nenhuma meta 💩', hobbies: 'Gabriel Cocozinho não colocou nenhuma meta 💩', conhecimentos: 'Gabriel Cocozinho não colocou nenhuma meta 💩' }, scoreBreakdown: { melhorFato: 0, piorFato: -1 } },
].map((participant) => ({
  ...participant,
  photoUrl: PARTICIPANT_PHOTOS_BY_ID[participant.id] ?? null,
}));
