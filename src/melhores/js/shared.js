...
export const INITIAL_PARTICIPANTS_DATA = [
  ...
  { id: 'leonardo', name: 'Leonardo', handle: '@leonardo', categories: { exercicio: 0, familia: 3, alimentacao: 4, hobbies: 3, conhecimentos: 2, bestWeek: 0 }, objectives: { exercicio: '3 exercícios na semana', familia: 'Visitar ou falar com meu irmão 1x por semana', alimentacao: 'Apenas 1 iFood/lanche fora na semana', hobbies: 'Basquete 1x por semana (30 min)', conhecimentos: 'Leitura 3x por semana' }, scoreBreakdown: { melhorFato: 1, piorFato: 0 } },
  ...
  { id: 'mavi', name: 'Mavi', handle: '@mavi', categories: { exercicio: 3, familia: 4, alimentacao: 2, hobbies: 0, conhecimentos: 1, bestWeek: -3 }, objectives: { exercicio: 'Exercício 4x na semana', familia: 'Ver meus pais 1x por semana', alimentacao: '1 refeição livre por semana', hobbies: 'Desenhar 3 peças de roupa por semana', conhecimentos: '1h de leitura por dia' }, scoreBreakdown: { melhorFato: 0, piorFato: 0 } },
  ...
  { id: 'luan', name: 'Luan', handle: '@luan', categories: { exercicio: 0, familia: 4, alimentacao: 0, hobbies: 0, conhecimentos: 4, bestWeek: 1 }, objectives: { exercicio: 'Musculação 3x na semana', familia: 'Ligar para mãe, Karol e avós 1x por semana', alimentacao: '11 refeições saudáveis na semana', hobbies: 'Jogar padel ou futebol 1x por semana', conhecimentos: '3h leitura + Duolingo diário' }, scoreBreakdown: { melhorFato: 1, piorFato: -1 } },
